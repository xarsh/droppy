		...
		drop : function(model, button) {
			...
			model.drop({
				success : function(response) {
					...
					button.children('span').text(ExposeTranslation.get('button.dropping'));
		...
		undrop : function(model, button) {
			...
			model.undrop({
				success : function(response) {
					...
					button.children('span').text(ExposeTranslation.get('button.drop'));
