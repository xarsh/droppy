...
class AJAXRequestController extends ContainerAware
{
	...
	{
	    $this->container->get('request')->attributes->set('_route', 'droppy_event_api_dropped_events');
	    return $this->container->get('droppy_event.api')->getDroppedEventsAction();
/*        $user = $this->checkInfosAndGetUser();
	...
	{
	    $this->container->get('request')->attributes->set('_route', 'droppy_event_api_update_event');
	    return $this->container->get('droppy_event.api')->updateEventAction();
	}
	...
	public function getEventUpdateHtmlAction()
	{
	    return $this->container->get('templating')->renderResponse('DroppyEventBundle:Includes:event_creation.html.twig');
	}
	
	public function getEventDetailsHtmlAction()
	{
	    return $this->container->get('templating')->renderResponse('DroppyEventBundle:Includes:event_details.html.twig');
	}
}