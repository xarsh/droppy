...
class PersonalDatas
{
	 ...
	 * @Assert\MaxLength(limit=30, message="error.personal_datas.displayed_name.too_long", groups={"Profile", "Registration"})
	 */
	 ...
	 * @Assert\MaxLength(limit=1000, message="error.personal_datas.introduction.too_long", groups={"Profile"})
	 */
