...
/**
 * Droppy\WebApplicationBundle\Entity\PrivacySettings
 *
...
class PrivacySettings
{
	 ...
	 */
	public function addAuthorizedCircle(\Droppy\UserBundle\Entity\User $authorizedCircle)
	{
		$this->authorizedCircles->add($authorizedCircle);
	}
